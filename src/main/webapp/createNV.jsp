...
<body>
<form action="/nv?action=create" method="post" >
  ...
  Ngày Sinh<br>
  <input type="date" placeholder="nhập vào ngày sinh yyyy-MM-dd" name="birthday" required><br><br>
  Địa chỉ <br>
  ...
  Lớp <br>
  <select  name="maP">
    <c:forEach var="lop" items="${phongs}">

      <option value="${lop.idP}">
          ${lop.tenphong}</option>
    </c:forEach>
  </select>
  <br><br>
